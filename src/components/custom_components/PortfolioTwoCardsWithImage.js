...
export default ({
  ...
  headingHtmlComponent = (
    <>
      We've done some <span tw="text-primary-500">amazing work.</span>
    </>
  ),
  description = "Getting the right partner is difficult. Therefore we created a platform to help connect you to the right partner. \
    Our platform uses advanced analytics to help connect businesses and influencers which have the perfect interest.",
  linkText = "View all Projects",
  cardLinkText = "Join Now",
  textOnLeft = false
}) => {
  const cards = [
    {
    ...
    {
      imageSrc:
      "https://images.unsplash.com/photo-1575439047055-83e6174df3b9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1868&q=80",
      company: "Influencers",
      type: "",
      title: "Get funded and help promote businesses, grow your network.",
      durationText: "180 Day Campaign",
      locationText: "Palo Alto",
      link: "/join-influencer"
    }
  ];
  return (
    <Container>
